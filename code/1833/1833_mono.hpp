...
public:
    ...
    auto maxIceCream(const std::vector<int>& costs, u32 coins) const noexcept
    {
        u32 r = 0;
        ...
        {
            // t: by as many bars with price 'x' as possible
            // and reset frequency value to make this structure
            // self-cleaning to prevent zeroing everything every time
