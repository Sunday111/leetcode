#include "2698_find_the_punishment_number_of_an_integertest_cases.hpp"
...
class t2698_find_the_punishment_number_of_an_integer
    : public ::testing::TestWithParam<size_t>
{
public:
};

TEST_P(t2698_find_the_punishment_number_of_an_integer, MinOperations)
{
...
INSTANTIATE_TEST_SUITE_P(
    Gen,
    t2698_find_the_punishment_number_of_an_integer,
