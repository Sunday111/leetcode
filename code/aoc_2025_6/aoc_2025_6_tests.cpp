...
TEST(taoc_2025_6, DISABLED_test_sample_1)
{
    ASSERT_EQ(Solution1{}.solve(kSampleInput), 4277556);
}

TEST(taoc_2025_6, DISABLED_test_input_1)
{
    ASSERT_EQ(Solution1{}.solve(kMyInput), 4387670995909);
}

TEST(taoc_2025_6, DISABLED_test_sample_2)
{
    ASSERT_EQ(Solution2{}.solve(kSampleInput), 3263827);
}

TEST(taoc_2025_6, DISABLED_test_input_2)
{
