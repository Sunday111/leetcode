...
struct Foo
{
    ...
    SIGNATURE_TEST_METHOD(
        ,
        const_volatile_noexcept_method,
        const volatile noexcept);
    SIGNATURE_TEST_METHOD(
        ,
        const_volatile_lref_noexcept_method,
        const volatile& noexcept);
    SIGNATURE_TEST_METHOD(
        ,
        const_volatile_rref_noexcept_method,
        const volatile&& noexcept);
...
#define SIGNATURE_TEST(                                                      \
    ...
    {                                                                        \
        ...
        static_assert(                                                       \
            std::is_same_v<typename Type::Args, std::tuple<float, double>>); \
